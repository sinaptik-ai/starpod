...
by detecting the restriction at runtime and applying an LD_PRELOAD shim.

Usage:
    python soffice.py --headless --convert-to pdf input.docx
...
def get_soffice_env() -> dict:
    """Get environment dict configured for running soffice."""
    env = os.environ.copy()
...
def run_soffice(args: list[str], **kwargs) -> subprocess.CompletedProcess:
    """Run soffice with proper environment configuration."""
    env = get_soffice_env()
    cmd = _find_soffice()
...
def _find_soffice() -> str:
    """Find the soffice binary across platforms."""
