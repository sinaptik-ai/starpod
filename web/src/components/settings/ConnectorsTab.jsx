...
const LOGOS = {
  ...
  mysql: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <ellipse cx="12" cy="6" rx="8" ry="3"/><path d="M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"/><path d="M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"/><line x1="20" y1="6" x2="20" y2="18" strokeDasharray="2 2"/>
    </svg>
  ),
  redis: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  mongodb: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M12.61 24c.08-.42.189-.84.31-1.25.055-.02.11-.06.165-.1-.06.04-.11.08-.165.1.13-.39.275-.78.44-1.17-.28-.155-.5-.31-.69-.5l-.07-.05c-.06.39-.12.79-.17 1.18-.11.56-.22 1.15-.34 1.79h.52z" opacity=".5"/>
    </svg>
  ),
  elasticsearch: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M13.394 0C8.217 0 3.82 3.38 2.186 8h14.808a3 3 0 0 0 2.486-1.325l2.16-3.2C19.677 1.32 16.746 0 13.394 0z"/>
      <path d="M1.549 10C1.2 10.955 1 11.955 1 13c0 1.045.2 2.045.549 3h12.257a2 2 0 0 0 1.657-.89l2.758-4.11a2 2 0 0 0 0-2.22l-2.148-3.2A2 2 0 0 0 14.416 10H1.549z" opacity=".7"/>
      <path d="M2.186 18c1.634 4.62 6.03 8 11.208 8 3.352 0 6.283-1.32 8.246-3.475l-2.16-3.2A3 3 0 0 0 16.994 18H2.186z" opacity=".4"/>
    </svg>
  ),
  stripe: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  aws: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M6.763 10.036a7.61 7.61 0 0 0 .065 1.396c.073.38.182.782.327 1.16.054.127.073.254.073.363 0 .163-.109.327-.309.49l-1.026.69a.773.773 0 0 1-.418.145c-.163 0-.327-.072-.472-.218a4.84 4.84 0 0 1-.563-.735 12.59 12.59 0 0 1-.49-.926c-1.228 1.447-2.77 2.17-4.625 2.17-1.32 0-2.373-.381-3.152-1.133C-4.604 12.71-5 11.756-5 10.583c0-1.247.436-2.261 1.32-3.03.884-.77 2.062-1.153 3.553-1.153.49 0 1.008.036 1.554.109.545.072 1.108.182 1.699.327V5.78c0-1.136-.236-1.934-.727-2.388C1.908 2.93 1.09 2.71 0 2.71a8.33 8.33 0 0 0-1.87.218c-.635.145-1.252.345-1.843.581a4.396 4.396 0 0 1-.545.218.87.87 0 0 1-.236.036c-.218 0-.327-.163-.327-.49V2.3c0-.254.036-.436.127-.545A1.34 1.34 0 0 1-4.222 1.5c.6-.29 1.3-.536 2.098-.727C-1.318.59-.474.5.387.5c1.79 0 3.097.418 3.935 1.247.83.83 1.247 2.098 1.247 3.79v4.499h1.194zm-6.39 2.388c.472 0 .963-.09 1.481-.254.518-.163.98-.472 1.372-.89.236-.272.418-.58.509-.944.09-.363.145-.8.145-1.3v-.626a12.52 12.52 0 0 0-1.355-.254 11.35 11.35 0 0 0-1.39-.09c-.963 0-1.664.182-2.134.563-.472.381-.7.917-.7 1.627 0 .654.163 1.153.509 1.481.327.345.8.509 1.39.509l.173.178z" transform="translate(5.5 4)"/>
      <path d="M18.5 16.8c-2.654 1.953-6.5 2.993-9.812 2.993-4.643 0-8.824-1.717-11.988-4.57-.254-.218-.027-.527.272-.363 3.408 1.99 7.625 3.187 11.988 3.187 2.94 0 6.17-.617 9.139-1.88.454-.182.826.29.4.633z" opacity=".7"/>
      <path d="M19.7 15.4c-.345-.436-2.28-.218-3.152-.109-.254.036-.29-.2-.063-.363 1.554-1.09 4.088-.772 4.387-.4.29.363-.09 2.934-1.536 4.16-.218.182-.436.09-.327-.163.327-.8 1.036-2.689.69-3.125z" opacity=".7"/>
    </svg>
  ),
  'google-cloud': (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.19 2a9.344 9.344 0 0 0-8.17 4.806l3.06 2.392A5.563 5.563 0 0 1 12.19 5.8h.01a5.518 5.518 0 0 1 3.874 1.593l2.8-2.8A9.325 9.325 0 0 0 12.19 2z" opacity=".8"/>
      <path d="M21.5 12.19c0-.69-.068-1.361-.19-2.01h-5.7v4h5.07a5.545 5.545 0 0 1-1.895 2.845L21.5 12.19z" opacity=".6"/>
      <path d="M5.02 14.26A5.569 5.569 0 0 1 6.6 12.19c0-1.03.282-1.993.768-2.822L4.02 6.806A9.319 9.319 0 0 0 2.85 12.19c0 1.877.553 3.623 1.498 5.09l2.672-3.02z" opacity=".4"/>
      <path d="M12.19 22c2.509 0 4.808-.854 6.59-2.3l-3.08-2.595a5.573 5.573 0 0 1-3.51 1.095 5.563 5.563 0 0 1-5.119-3.94L4.02 17.28A9.33 9.33 0 0 0 12.19 22z" opacity=".6"/>
    </svg>
  ),
  azure: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  'google-calendar': (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M10 14l2 2 4-4"/>
    </svg>
  ),
  'google-sheets': (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M14.727 6.727H14V0H4.91c-.905 0-1.637.732-1.637 1.636v20.728c0 .904.732 1.636 1.636 1.636h14.182c.904 0 1.636-.732 1.636-1.636V6.727h-5.273z" opacity=".4"/>
  ...
  jira: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M5.024 5.247h11.571a5.218 5.218 0 0 0 5.232 5.215h-2.13v2.057A5.215 5.215 0 0 0 14.484 17.734V6.252a1.005 1.005 0 0 0-1.005-1.005H5.024z" opacity=".7" transform="translate(-1.732 -.247)"/>
      <path d="M11.571 0H0a5.218 5.218 0 0 0 5.232 5.215h2.13v2.057A5.215 5.215 0 0 0 12.575 12.487V1.005A1.005 1.005 0 0 0 11.571 0z" opacity=".4" transform="translate(5.476)"/>
    </svg>
  ),
  twilio: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  sendgrid: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22,6 12,13 2,6"/><path d="M2 20l7-7"/><path d="M22 20l-7-7"/>
    </svg>
  ),
  vercel: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  supabase: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M13.7 21.7c-.5.6-1.5.2-1.5-.6V13h8.6c1 0 1.5 1.1.8 1.8L13.7 21.7z" opacity=".6"/>
  ...
  anthropic: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M8.37 3L1 21h3.525l1.554-3.927h5.358L10.035 13.5H4.62L8.37 3z" opacity=".7"/>
    </svg>
  ),
  sentry: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
const FALLBACK_LOGO = (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M6 8H5a4 4 0 0 0 0 8h1"/><line x1="8" y1="12" x2="16" y2="12"/>
  </svg>
)
...
export default function ConnectorsTab() {
  ...
  const load = useCallback(() => {
    Promise.all([
      fetch('/api/settings/connectors', { headers: apiHeaders() }).then(r => r.json()),
      fetch('/api/settings/connector-templates', { headers: apiHeaders() }).then(r => r.json()),
      fetch('/api/settings/vault', { headers: apiHeaders() }).then(r => r.json()),
    ])
      .then(([c, t, v]) => {
      ...
      .catch(() => setStatus({ type: 'error', text: 'Failed to load connectors' }))
  }, [])
  ...
  const handleDelete = async (name) => {
    ...
    setStatus(null)
    try {
      const resp = await fetch(`/api/settings/connectors/${encodeURIComponent(name)}`, {
        method: 'DELETE',
        headers: apiHeaders(),
      })
      if (resp.ok) {
  ...
  const handleSaveOAuth = async (connName) => {
    setSaving('oauth')
    setStatus(null)
    const prefix = connName.toUpperCase().replace(/-/g, '_')
    try {
      const saves = []
      if (oauthClientId.trim()) {
        saves.push(fetch(`/api/settings/vault/${encodeURIComponent(prefix + '_CLIENT_ID')}`, {
          method: 'PUT', headers: apiHeaders(),
          body: JSON.stringify({ value: oauthClientId.trim() }),
        }))
      }
      if (oauthClientSecret.trim()) {
        saves.push(fetch(`/api/settings/vault/${encodeURIComponent(prefix + '_CLIENT_SECRET')}`, {
          method: 'PUT', headers: apiHeaders(),
          body: JSON.stringify({ value: oauthClientSecret.trim() }),
        }))
      }
      ...
      if (results.every(r => r.ok)) {
        ...
        setStatus({ type: 'ok', text: 'OAuth credentials saved' })
        load()
      } else {
        setStatus({ type: 'error', text: 'Failed to save credentials' })
      }
    } catch (e) {
      setStatus({ type: 'error', text: e.message })
    }
  ...
  const handleOAuthConnect = async (connName) => {
    setSaving('oauth-connect')
    setStatus(null)
    try {
      const resp = await fetch(`/api/settings/connectors/${encodeURIComponent(connName)}/oauth/start`, {
        headers: apiHeaders(),
      })
      if (resp.ok) {
        ...
        const err = await resp.json().catch(() => ({}))
        setStatus({ type: 'error', text: err.error || 'Failed to start OAuth' })
      }
    } catch (e) {
      setStatus({ type: 'error', text: e.message })
    }
  ...
  const selectedTpl = selectedConn ? templates.find(t => t.name === selectedConn.type) : null
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '16px' }}>
        <div>
          <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--color-secondary)', marginBottom: '4px' }}>
            Connectors
          </div>
        ...
        <div style={{ position: 'relative', flexShrink: 0 }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--color-dim)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          ...
          <input
            ...
            style={{
              width: '180px', fontSize: '12px', paddingLeft: '28px',
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'var(--color-elevated)' : isConfigured ? 'var(--color-surface)' : 'var(--color-bg)',
                border: 'none', cursor: 'pointer', transition: 'background 0.15s ease', position: 'relative',
              }}
              onMouseEnter={e => { if (!isActive) e.currentTarget.style.background = 'var(--color-elevated)' }}
              onMouseLeave={e => { if (!isActive) e.currentTarget.style.background = isConfigured ? 'var(--color-surface)' : 'var(--color-bg)' }}
              title={isConfigured ? `${tpl.display_name} — ${conn.status}` : `Add ${tpl.display_name}`}
            >
              {isConfigured && (
                <span style={{
                  position: 'absolute', top: 8, right: 8, width: 6, height: 6, borderRadius: '50%',
                  background: isConnected ? 'var(--color-ok)' : 'var(--color-dim)',
                }} />
              )}
              <span style={{
                color: isConfigured ? 'var(--color-primary)' : 'var(--color-dim)',
              ...
              <span style={{
                fontSize: '10px', textAlign: 'center', lineHeight: 1.2, maxWidth: '80px',
                overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                color: isConfigured ? 'var(--color-secondary)' : 'var(--color-dim)',
              }}>
                {tpl.display_name}
              </span>
            </button>
      ...
      {filteredTemplates.length === 0 && (
        <div style={{ textAlign: 'center', padding: '24px', color: 'var(--color-dim)', fontSize: '12px' }}>
      ...
      {namingType && (
        <div style={{
          ...
          <span style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
            Name this {templates.find(t => t.name === namingType)?.display_name} instance
          </span>
          <div style={{ display: 'flex', gap: '8px' }}>
            <input
              ...
              autoFocus
            />
            <button className="s-save-btn" style={{ padding: '4px 12px', fontSize: '12px' }} disabled={!instanceName.trim() || saving === 'add'} onClick={handleNameSubmit}>
              {saving === 'add' ? '...' : 'Add'}
            </button>
            <button
      ...
      {/* Detail panel */}
      {selectedConn && (
        <div style={{ border: '1px solid var(--color-border-subtle)', background: 'var(--color-surface)' }}>
          {/* Header */}
          <div style={{
              ...
              <div>
                <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--color-primary)' }}>
                  ...
                  {selectedConn.name !== selectedConn.type && (
                    <span style={{ fontWeight: 400, fontSize: '11px', color: 'var(--color-dim)', marginLeft: '8px', fontFamily: 'var(--font-mono)' }}>
                      {selectedConn.name}
                    </span>
                  )}
                </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              {selectedConn.status === 'connected' && (
                <span style={{ fontSize: '11px', color: 'var(--color-ok)', display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--color-ok)' }} />
                  Connected
                </span>
              )}
              <button
                style={{ background: 'none', border: 'none', color: 'var(--color-dim)', cursor: 'pointer', padding: '4px', fontSize: '16px', lineHeight: 1 }}
          ...
          <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {selectedConn.secrets?.length > 0 && (
              <Section title="Secrets">
                {selectedConn.secrets.map(key => {
                  ...
                  return (
                    <div key={key} style={{ display: 'flex', alignItems: 'center', gap: '8px', minHeight: '32px' }}>
                      <span style={{
                        fontSize: '12px', fontFamily: 'var(--font-mono)', width: '200px', flexShrink: 0,
                        color: isSet ? 'var(--color-secondary)' : 'var(--color-warn)',
                      }}>
                        {key}
                      </span>
                      {isSet ? (
                        <span style={{ fontSize: '11px', color: 'var(--color-ok)' }}>&check; set</span>
                      ) : (
                        <>
                          <input
                            className="s-input" type="password" placeholder="Paste value..."
                            value={secretValues[key] || ''}
                            onChange={e => setSecretValues(prev => ({ ...prev, [key]: e.target.value }))}
                            style={{ flex: 1, fontFamily: 'var(--font-mono)', fontSize: '12px' }}
                          />
                          <button className="s-save-btn" style={{ padding: '4px 12px', fontSize: '11px', flexShrink: 0 }}
                            disabled={!secretValues[key]?.trim() || saving === key}
            ...
            {/* OAuth */}
            {(selectedConn.auth_method === 'oauth' || selectedConn.oauth_token_url) && selectedTpl?.has_oauth && (
              <Section title="OAuth">
                {selectedConn.oauth_token_key && (
                  <KVRow label="Access token" value={selectedConn.oauth_token_key} ok={vaultKeys.has(selectedConn.oauth_token_key)} />
                )}
                {selectedConn.oauth_refresh_key && (
                  <KVRow label="Refresh token" value={selectedConn.oauth_refresh_key} ok={vaultKeys.has(selectedConn.oauth_refresh_key)} />
                )}
                {selectedConn.oauth_expires_at && (
                  <KVRow label="Expires" value={selectedConn.oauth_expires_at} />
                )}
                {selectedTpl.oauth_scopes && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minHeight: '28px' }}>
                    <span style={{ fontSize: '11px', color: 'var(--color-dim)', width: '200px', flexShrink: 0 }}>Scopes</span>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px' }}>
                      {selectedTpl.oauth_scopes.map(s => (
                        <span key={s} style={{
                          padding: '1px 6px', fontSize: '10px', fontFamily: 'var(--font-mono)',
                          border: '1px solid var(--color-border-main)', color: 'var(--color-dim)',
                        }}>{s}</span>
                      ))}
                    </div>
                  </div>
                ...
                {(() => {
                  const prefix = selectedConn.name.toUpperCase().replace(/-/g, '_')
                  const cidKey = prefix + '_CLIENT_ID'
                  const csKey = prefix + '_CLIENT_SECRET'
                  const cidSet = vaultKeys.has(cidKey)
                  const csSet = vaultKeys.has(csKey)

                  return (
                    <div style={{ marginTop: '8px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      <span style={{ fontSize: '11px', color: 'var(--color-dim)' }}>Client credentials</span>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--color-secondary)', width: '200px', flexShrink: 0 }}>{cidKey}</span>
                        {cidSet ? (
                          <span style={{ fontSize: '11px', color: 'var(--color-ok)' }}>&check; set</span>
                        ) : (
                          <input className="s-input" type="password" placeholder="Client ID" value={oauthClientId} onChange={e => setOauthClientId(e.target.value)} style={{ flex: 1, fontFamily: 'var(--font-mono)', fontSize: '12px' }} />
                        )}
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--color-secondary)', width: '200px', flexShrink: 0 }}>{csKey}</span>
                        {csSet ? (
                          <span style={{ fontSize: '11px', color: 'var(--color-ok)' }}>&check; set</span>
                        ) : (
                          <input className="s-input" type="password" placeholder="Client secret" value={oauthClientSecret} onChange={e => setOauthClientSecret(e.target.value)} style={{ flex: 1, fontFamily: 'var(--font-mono)', fontSize: '12px' }} />
                        )}
                      </div>

                      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '4px' }}>
                        {(!cidSet || !csSet) && (
                          <button className="s-save-btn" style={{ padding: '4px 12px', fontSize: '11px' }}
                            disabled={(!oauthClientId.trim() && !oauthClientSecret.trim()) || saving === 'oauth'}
                            onClick={() => handleSaveOAuth(selectedConn.name)}>
                            {saving === 'oauth' ? '...' : 'Save credentials'}
                          </button>
                        )}
                        {cidSet && csSet && (
                          <button className="s-save-btn" style={{ padding: '4px 12px', fontSize: '11px' }}
                            disabled={saving === 'oauth-connect'}
                            onClick={() => handleOAuthConnect(selectedConn.name)}>
                            {saving === 'oauth-connect' ? '...' : selectedConn.status === 'connected' ? 'Reconnect with OAuth' : 'Connect with OAuth'}
                          </button>
                        )}
                      </div>
                    </div>
            ...
            {Object.keys(editConfig).length > 0 && (
              <Section title="Configuration">
                {Object.entries(editConfig).map(([k, v]) => (
                  <div key={k} style={{ display: 'flex', alignItems: 'center', gap: '8px', minHeight: '32px' }}>
                    <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--color-secondary)', width: '200px', flexShrink: 0 }}>{k}</span>
                    <input className="s-input" value={v}
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '4px' }}>
                  <button className="s-save-btn" style={{ padding: '4px 12px', fontSize: '11px' }}
                    disabled={saving === 'config'} onClick={() => handleSaveConfig(selectedConn.name)}>
            ...
            {/* Remove */}
            <div style={{ borderTop: '1px solid var(--color-border-subtle)', paddingTop: '12px', display: 'flex', justifyContent: 'flex-end' }}>
              {confirmDelete ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ fontSize: '12px', color: 'var(--color-err)' }}>Remove this connector?</span>
                  <button className="s-save-btn" style={{ background: 'var(--color-err)', padding: '4px 12px', fontSize: '11px' }}
                    onClick={() => handleDelete(selectedConn.name)} disabled={saving === 'del'}>
                    {saving === 'del' ? '...' : 'Yes, remove'}
                  </button>
                  <button className="s-save-btn"
                    style={{ background: 'transparent', color: 'var(--color-muted)', border: '1px solid var(--color-border-main)', padding: '4px 12px', fontSize: '11px' }}
                    onClick={() => setConfirmDelete(false)}>Cancel</button>
                </div>
              ) : (
                <button style={{ background: 'none', border: 'none', color: 'var(--color-dim)', cursor: 'pointer', fontSize: '12px', padding: '4px 0' }}
      ...
      {/* Status toast */}
      {status && (
        <div style={{ fontSize: '12px', color: status.type === 'ok' ? 'var(--color-ok)' : 'var(--color-err)' }}>
          {status.text}
        </div>
      )}
    </div>
...
function Section({ title, children }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      <span style={{ fontSize: '10px', color: 'var(--color-dim)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600 }}>
        {title}
      </span>
      {children}
    </div>
...
function KVRow({ label, value, ok }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minHeight: '28px' }}>
      <span style={{ fontSize: '11px', color: 'var(--color-dim)', width: '200px', flexShrink: 0 }}>{label}</span>
      <span style={{
        fontSize: '11px', fontFamily: 'var(--font-mono)',
        color: ok === true ? 'var(--color-ok)' : ok === false ? 'var(--color-warn)' : 'var(--color-secondary)',
      }}>
        {value} {ok === true && '\u2713'}{ok === false && '(missing)'}
      </span>
    </div>
  )
}
